...
setup(
    ...
    scripts=[
        ...
        'scripts/oneoffs/migrate_openbts_subscribers',
        'scripts/oneoffs/migrate_to_crdt_balance',
        'scripts/oneoffs/rollback_to_0.5.13',
        'scripts/oneoffs/remove_bts_sip_profiles',
